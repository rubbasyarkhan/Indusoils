...
const SingleProduct = ({ imgURL, name }) => {
  return (
    <div className="flex flex-col  w-full sm:w-[60%] lg:w-[80%] items-center gap-2 py-10 transition-shadow group">
      {/* Image Container */}
      ...
      {/* Product Name */}
      <h2 className="text-lg sm:text-xl lg:text-2xl xl:text-2xl font-semibold text-center">{name}</h2>
    </div>
  );
};
